...
6. You can now simply overwrite any of the values within range the of 25600 (it must be below 25600) and then hit "Ctrl + S" and then refresh the page and click on the new dpi value
